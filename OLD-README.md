...
El proyecto PIA (Pio Baroja + IA) consiste en el desarrollo de una aplicación web para permitir que los profesores hagan consultas sobre documentos internos (planes de estudio, normativas, notas, etc), y reciban una respuesta con la información necesaria.
